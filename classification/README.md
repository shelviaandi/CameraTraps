...
Now you are ready to run the training. Go to `classification/tf-slim/` and execute your script with `bash ../training_scripts/train_newdataset_inception_v4.sh`.
